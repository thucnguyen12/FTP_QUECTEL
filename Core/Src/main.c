...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, GSM_PWR_KEY_Pin|GSM_RESET_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GSM_PWR_EN_GPIO_Port, GSM_PWR_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : GSM_PWR_KEY_Pin GSM_RESET_Pin */
  GPIO_InitStruct.Pin = GSM_PWR_KEY_Pin|GSM_RESET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : GSM_PWR_EN_Pin */
